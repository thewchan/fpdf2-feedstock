...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fpdf2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12215&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fpdf2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fpdf2` can be installed with:

```
conda install fpdf2
```

It is possible to list all of the versions of `fpdf2` available on your platform with:
